...
type alias BackendUserData =
    { hiddenUsers : SeqSet.SeqSet Evergreen.V80.User.UserId
    , hiddenForAll : Bool
...
type BackendError
    = PostmarkError Evergreen.V80.EmailAddress2.EmailAddress Evergreen.V80.Postmark.SendEmailError
...
type BackendMsg
    ...
    | ConfirmationEmailSent Lamdera.SessionId Time.Posix (Result Evergreen.V80.Postmark.SendEmailError ())
    | ChangeEmailSent Time.Posix Evergreen.V80.EmailAddress2.EmailAddress (Result Evergreen.V80.Postmark.SendEmailError ())
...
type alias LoadingData_ =
    ...
    , grid : Evergreen.V80.Grid.Grid
    , hiddenUsers : SeqSet.SeqSet Evergreen.V80.User.UserId
    , adminHiddenUsers : SeqSet.SeqSet Evergreen.V80.User.UserId
    , undoHistory : List (Dict.Dict Evergreen.V80.Helper.RawCellCoord Int)
    , redoHistory : List (Dict.Dict Evergreen.V80.Helper.RawCellCoord Int)
    , undoCurrent : Dict.Dict Evergreen.V80.Helper.RawCellCoord Int
