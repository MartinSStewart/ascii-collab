module Ascii exposing (Ascii(..), asciiChars, asciis, charsPerRow, default, fromChar, fromInt, intensity, size, textureData, textureHeight, texturePosition, texturePositionInt, textureWidth, toChar, toInt)
